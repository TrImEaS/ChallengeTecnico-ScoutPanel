...
export default function PlayerInfoCard({ player }: { player: Route.ComponentProps["loaderData"]["player"] }) {
  const Row = ({ label, value, iconBase }: { label: string; value: React.ReactNode; iconBase?: string }) => (
